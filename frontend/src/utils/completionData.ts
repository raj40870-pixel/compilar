...
export const LANGUAGE_COMPLETIONS: Record<string, CompletionItem[]> = {
  ...
  typescript: [
    { label: 'console.log', kind: 15, insertText: 'console.log($1);', detail: 'Log to console' },
    { label: 'interface', kind: 14, insertText: 'interface ${1:Name} {\n\t$0\n}', detail: 'Interface definition' },
    { label: 'type', kind: 14, insertText: 'type ${1:Name} = $2;', detail: 'Type alias' },
    { label: 'const', kind: 14, insertText: 'const ', detail: 'Constant declaration' },
    { label: 'let', kind: 14, insertText: 'let ', detail: 'Variable declaration' },
    { label: 'function', kind: 15, insertText: 'function ${1:name}(${2:params}): ${3:void} {\n\t$0\n}', detail: 'Function declaration' },
    { label: 'if', kind: 15, insertText: 'if (${1:condition}) {\n\t$0\n}', detail: 'If statement' },
    { label: 'for', kind: 15, insertText: 'for (let ${1:i} = 0; ${1:i} < ${2:array}.length; ${1:i}++) {\n\t$0\n}', detail: 'For loop' },
  ],
  csharp: [
    { label: 'Console.WriteLine', kind: 15, insertText: 'Console.WriteLine($1);', detail: 'Print to console' },
    { label: 'Console.ReadLine', kind: 15, insertText: 'Console.ReadLine()', detail: 'Read from console' },
    { label: 'class', kind: 14, insertText: 'class ${1:ClassName}\n{\n\t$0\n}', detail: 'Class definition' },
    { label: 'public', kind: 14, insertText: 'public ', detail: 'Access modifier' },
    { label: 'private', kind: 14, insertText: 'private ', detail: 'Access modifier' },
    { label: 'void', kind: 14, insertText: 'void ', detail: 'Return type' },
    { label: 'using', kind: 14, insertText: 'using $1;', detail: 'Namespace import' },
    { label: 'namespace', kind: 14, insertText: 'namespace ${1:MyNamespace}\n{\n\t$0\n}', detail: 'Namespace definition' },
  ],
  go: [
    { label: 'fmt.Println', kind: 15, insertText: 'fmt.Println($1)', detail: 'Print line' },
    { label: 'fmt.Printf', kind: 15, insertText: 'fmt.Printf("$1", $2)', detail: 'Print formatted' },
    { label: 'func', kind: 15, insertText: 'func ${1:name}(${2:params}) {\n\t$0\n}', detail: 'Function definition' },
    { label: 'import', kind: 14, insertText: 'import (\n\t"$1"\n)', detail: 'Import block' },
    { label: 'package main', kind: 15, insertText: 'package main\n\nimport "fmt"\n\nfunc main() {\n\t$0\n}', detail: 'Main file package' },
    { label: 'if', kind: 15, insertText: 'if ${1:condition} {\n\t$0\n}', detail: 'If statement' },
    { label: 'for', kind: 15, insertText: 'for ${1:i} := 0; ${1:i} < ${2:n}; ${1:i}++ {\n\t$0\n}', detail: 'For loop' },
    { label: 'struct', kind: 14, insertText: 'type ${1:Name} struct {\n\t$0\n}', detail: 'Struct definition' },
  ],
  php: [
    { label: 'echo', kind: 15, insertText: 'echo $1;', detail: 'Output text' },
    { label: 'function', kind: 15, insertText: 'function ${1:name}(${2:params}) {\n\t$0\n}', detail: 'Function definition' },
    { label: 'if', kind: 15, insertText: 'if (${1:condition}) {\n\t$0\n}', detail: 'If statement' },
    { label: 'for', kind: 15, insertText: 'for ($${1:i} = 0; $${1:i} < ${2:n}; $${1:i}++) {\n\t$0\n}', detail: 'For loop' },
    { label: 'foreach', kind: 15, insertText: 'foreach ($${1:array} as $${2:item}) {\n\t$0\n}', detail: 'Foreach loop' },
    { label: 'php tag', kind: 15, insertText: '<?php\n\n$0', detail: 'PHP opening tag' },
  ],
  rust: [
    { label: 'println!', kind: 15, insertText: 'println!("$1");', detail: 'Print to console' },
    { label: 'fn main', kind: 15, insertText: 'fn main() {\n\t$0\n}', detail: 'Main function' },
    { label: 'fn', kind: 15, insertText: 'fn ${1:name}(${2:params}) -> ${3:type} {\n\t$0\n}', detail: 'Function definition' },
    { label: 'let mut', kind: 14, insertText: 'let mut ${1:var} = ${2:value};', detail: 'Mutable variable' },
    { label: 'match', kind: 15, insertText: 'match ${1:val} {\n\t${2:pattern} => $3,\n\t_ => $4,\n}', detail: 'Match pattern' },
    { label: 'struct', kind: 14, insertText: 'struct ${1:Name} {\n\t$0\n}', detail: 'Struct definition' },
    { label: 'impl', kind: 15, insertText: 'impl ${1:Name} {\n\t$0\n}', detail: 'Implementation block' },
    { label: 'for', kind: 15, insertText: 'for ${1:i} in ${2:iter} {\n\t$0\n}', detail: 'For loop' },
  ],
};
